(function () {
  ...
  const Pyre = (function () {
    ...
    const _dot = document.getElementById('pyre__dot');
    const _status = document.getElementById('pyre__status');
    const _connection = document.getElementById('pyre__connection');
    ...
    function error_cb (e) {
      ...
      _dot.className = 'connection__dot connection__dot--disconnected int--label';
    }
    
    function open_cb () {
      _status.textContent = 'Connected';
      _dot.className = 'connection__dot connection__dot--connected int--label';
    }
    ...
    function message_cb (event) {
      ...
      if (!data.target) {
        console.warn('PyreLive: target property missing from message.');
        return
      }
    ...
    function search () {
      ...
      _dot.className = 'connection__dot connection__dot--scanning int--label';
    ...
    Pyre.send = function (config) {
      if (_socket && _socket.readyState === WebSocket.OPEN) {
        _socket.send(JSON.stringify(config));
      }
    };

    Pyre.on = function (target, callback) {
